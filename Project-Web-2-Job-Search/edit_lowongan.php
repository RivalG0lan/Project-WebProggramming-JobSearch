...
<body>
    <div class="layout">
        ...
        <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="posting_lowongan.php" class="nav-item active">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <h1 class="page-title">Edit Lowongan Baru</h1>
            ...
            <div class="step-progress">
                ...
                <div class="step-item inactive" id="step3">
                    ...
                    <div class="step-label">Skills & Benefit</div>
                </div>
            </div>
            ...
            <div class="content-wrapper">
                ...
                <form method="POST">
                    ...
                    <div id="form-step1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="text" name="judul" value="<?= $data['judul']; ?>" class="form-input"  placeholder="e.g. Senior Frontend Developer">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="kategori" value="<?= $data['kategori']; ?>" class="form-input" placeholder="e.g. Engineering">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="lokasi" value="<?= $data['lokasi']; ?>" class="form-input" placeholder="e.g. Jakarta">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="gaji" value="<?= $data['gaji']; ?>" class="form-input" placeholder="Min (e.g. 20000000)">
                                </div>
                                <div class="input-with-icon">
                                    <svg class="input-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <line x1="12" y1="1" x2="12" y2="23"></line>
                    ...
                    <div id="form-step2" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" class="form-textarea"><?= $data['deskripsi']; ?></textarea>
                ...
                <div class="score-sidebar">
                    ...
                    <p class="score-message">Lengkapi informasi untuk hasil lebih baik</p>
    ...
    <script>
        ...
        function updateScore() {
            ...
            if (score >= 60) {
                scoreBar.style.background = '#0d9488';
            } else if (score >= 30) {
