    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .card-hero {
            ...
            padding:32px; color:white; position:relative;
        }
        .card-hero-badge {
            display:inline-flex; align-items:center; gap:6px;
        ...
        .card-hero h1 { font-size:28px; font-weight:700; margin-bottom:8px; }
        .card-hero-meta {
            display:flex; align-items:center; gap:20px; flex-wrap:wrap;
            font-size:14px; opacity:0.9;
        }
        .card-hero-meta-item { display:flex; align-items:center; gap:6px; }
        ...
        .tag.teal { background:#e0f2f1; color:#0d9488; }
        ...
        .info-box-icon {
            ...
            border:1px solid #e5e7eb; display:flex; align-items:center;
            justify-content:center; color:#0d9488; flex-shrink:0;
        }
        .info-box-label { font-size:11px; color:#9ca3af; font-weight:600; text-transform:uppercase; letter-spacing:0.5px; }
        .info-box-value { font-size:15px; font-weight:600; color:#111827; }
        ...
        .apply-bar {
            ...
            padding:20px 32px; border-top:1px solid #f3f4f6; flex-wrap:wrap; gap:12px;
        }
        .apply-salary { font-size:24px; font-weight:700; color:#0d9488; }
        .apply-salary-label { font-size:12px; color:#9ca3af; }
        .btn-apply {
            padding:14px 32px; background:#0d9488; color:white; border:none;
        ...
        .btn-apply-disabled {
            padding:14px 32px; background:#f3f4f6; color:#9ca3af; border:none;
        ...
        .side-card-title { font-size:16px; font-weight:700; color:#111827; margin-bottom:16px; }
        .company-info-row {
            display:flex; align-items:center; gap:12px; margin-bottom:16px;
        }
        .company-logo {
            width:56px; height:56px; background:#fef3c7; border-radius:12px;
            display:flex; align-items:center; justify-content:center;
            font-size:22px; font-weight:700; color:#d97706; flex-shrink:0;
        }
        .company-name { font-size:16px; font-weight:700; color:#111827; }
        .company-label { font-size:13px; color:#6b7280; }
        .company-detail {
        ...
        .other-job:last-child { border-bottom:none; }
        .other-job:hover .other-job-title { color:#0d9488; }
        .other-job-icon {
            width:40px; height:40px; background:#e0f2f1; border-radius:8px;
            display:flex; align-items:center; justify-content:center;
            color:#0d9488; flex-shrink:0;
        }
        .other-job-title { font-size:14px; font-weight:600; color:#111827; margin-bottom:2px; }
        .other-job-meta { font-size:12px; color:#9ca3af; }

        /* Already applied banner */
        .already-applied {
            background:#e0f2f1; border:1px solid #99f6e4; border-radius:10px;
            padding:14px 16px; display:flex; align-items:center; gap:10px;
            font-size:14px; font-weight:600; color:#0d9488; margin-bottom:0;
        }
                ...
                <div class="info-grid">
                    <div class="info-box">
                        ...
                        <div>
                            ...
                            <div class="info-box-value">Rp <?= number_format($data['gaji'],0,',','.') ?></div>
                        </div>
                    </div>
                    <div class="info-box">
                        <div class="info-box-icon">
        ...
        <div class="side-panel">
                ...
                <a href="detail_lowongan.php?id=<?= $oj['id_lowongan'] ?>" class="other-job">
                    ...
                    <div>
                        ...
                        <div class="other-job-meta">
                            <?= htmlspecialchars($oj['lokasi']) ?> · Rp <?= number_format($oj['gaji'],0,',','.') ?>
                        </div>
                    </div>
                </a>
                <?php endwhile; ?>
            ...
            <div class="side-card" style="background:#f0fdfa; border-color:#99f6e4;">
                <div style="display:flex; gap:10px; align-items:flex-start;">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0d9488" stroke-width="2" style="flex-shrink:0; margin-top:2px;">
                        <circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>
                    </svg>
                    <div>
                        <div style="font-size:14px; font-weight:700; color:#0d9488; margin-bottom:4px;">Tips Melamar</div>
                        <div style="font-size:13px; color:#374151; line-height:1.5;">
                            Pastikan profil Anda lengkap dan CV sudah terupload sebelum melamar untuk meningkatkan peluang diterima.
                        </div>
                    </div>
                </div>
            </div>
