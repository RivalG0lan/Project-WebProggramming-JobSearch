...
if (isset($_POST['login'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM users WHERE email=? AND role='pelamar'");
    ...
    if ($data) {
        ...
        if (password_verify($password_input, $password_db)) {
            ...
            $is_valid = true;
            // Opsional: rehash password ke format baru bisa dilakukan di sini
        }
...
<head>
    ...
    <title>Masuk ke Akun - LokerIn</title>
    ...
    <div class="container">
        ...
        <div class="right-side">
            <div class="hero-content">
                ...
                <p>Masuk ke akun Anda untuk melanjutkan perjalanan karir atau menemukan kandidat terbaik.</p>
            </div>
        </div>
        ...
        <div class="left-side">
            <div class="form-container">
                ...
                <div class="user-type-toggle">
                    <a href="login_pelamar.php" class="type-btn active">
                    ...
                    <a href="login_perusahaan.php" class="type-btn">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2">
                ...
                <div class="footer-link">
                    Belum punya akun? <a href="tipe_akun.html">Daftar Gratis</a>
                </div>
            </div>
        </div>
    </div>
