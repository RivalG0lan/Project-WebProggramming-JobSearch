  ...
  <div class="layout">
    ...
    <aside class="sidebar">
      ...
      <nav>
        ...
        <a href="pengaturan_perusahaan.php" class="nav-item active">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <main class="main-content">
      ...
      <div class="settings-section">
        ...
        <div class="toggle-group">
          <div class="toggle-info">
            <div class="toggle-label">Update Lowongan</div>
            <div class="toggle-description">
              Notifikasi tentang status Lowongan Anda
            </div>
          </div>
          <div class="toggle-switch active">
            <div class="toggle-slider"></div>
      ...
      <div class="settings-section">
        ...
        <div class="toggle-group">
          <div class="toggle-info">
            ...
            <div class="toggle-description">
              Tampilkan status "Mencari Pelamar" di profil
            </div>
          </div>
          <div class="toggle-switch active">
            <div class="toggle-slider"></div>
        ...
        <div class="toggle-group">
          <div class="toggle-info">
            <div class="toggle-label">Sembunyikan dari Pelamar</div>
            <div class="toggle-description">
              Sembunyikan profil dari pelamar saat ini
            </div>
          </div>
          <div class="toggle-switch">
            <div class="toggle-slider"></div>
